...
export const interviewsModuleApi = {
  ...
  createForm: async (projectId, campaignId, payload) => normalizeForm(await interviewsApi.createForm(projectId, campaignId, payload)),
  updateForm: async (id, payload) => normalizeForm(await interviewsApi.updateForm(id, payload)),
